    ...
    return(
        <div>
            <form class = "m-4 text-center">
                <h1 className="font-bold container text-4xl p-4"> DONATE </h1>
                <p> MAYBE DISPLAY THE INFO FOR THE EVENT OR THE NON-PROFIT</p>
                ...
                <div class="flex items-start mb-6">
                    ...
                    <label for="remember" class="ms-2 text-sm font-medium text-gray-900 dark:text-black">I want this donation to be anonymous</label>
                </div>
